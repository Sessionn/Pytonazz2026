...
- Login: focus e digitazione hanno priorità sul puntatore; gli eventi mouse sono ignorati durante la compilazione e per un secondo dopo l'ultimo input. Il corpo raggiunge una posa sul campo con interpolazione smorzata di 1,7 secondi; la password usa una curva più raccolta, con coda sollevata verso il muso. Le reazioni ai tasti non leggono i caratteri. All'uscita dalla posa la locomozione riparte dalla geometria visibile, con velocità iniziale zero.
- Dopo il login una transizione dell’intero corpo parte dalla geometria visibile e raggiunge gradualmente la curva di destinazione. Alla fine compare un vero PNG, `rest.png`, e il ciclo di rendering termina. L’immagine è nel layout della pagina e segue lo scroll senza inseguire il viewport. Soltanto i pulsanti “Aggiorna” e “Aggiorna elenco” attivano una sequenza locale di 4,2 secondi: la testa percorre un circuito raccordato alla curva di riposo e il corpo segue la stessa traiettoria, ritorno al PNG. I clic ripetuti non accodano animazioni. Statistiche, filtri, paginazione, puntatore e cambi di sezione non la avviano. Pausa, movimento ridotto e scheda nascosta sono rispettati.
